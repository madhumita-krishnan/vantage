'use strict';
// Vantage viewer app. One job: open a personal link in a window whose contents the operating system excludes
// from screenshots, screen recording and screen sharing (macOS: NSWindowSharingNone; Windows: WDA_EXCLUDEFROMCAPTURE).
// Links look like  vantage://open?u=<the personal link>  and are copied from the console's "App link" button.
// Nothing else: no menus, no local storage beyond the session cookie, navigation locked to the Vantage the link points at.
// Limits: Linux has no such flag, and no software stops a phone camera pointed at the screen.
const { app, BrowserWindow, shell } = require('electron');

const SCHEME = 'vantage';
let win = null,
  lockedOrigin = null,
  pending = null;
...
const PASTE_PAGE =
  ...
  encodeURIComponent(`<!doctype html><meta charset="utf-8"><title>Vantage</title>
...
<h1>Vantage</h1><p>Paste the link you were sent. This window is excluded from screenshots and screen sharing.</p>
